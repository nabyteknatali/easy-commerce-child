		...
		<table class="variations" cellspacing="0">
			<tbody>
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
                    <tr>
                        <td class="label" style="text-align: left;"><label for="<?php echo esc_attr( sanitize_title( $attribute_name ) ); ?>"><?php echo esc_html( wc_attribute_label( $attribute_name ) ); ?></label></td>
                    </tr>
					<tr>
						...
						<td class="value">
							<?php
                                ...
                                wc_dropdown_variation_attribute_options_custom( array(
									'options'   => $options,
